...
//        logger.info("===>>>消费者two-接收" + RabbitConfig.QUEUE_A + "消息" + msg);
//        try {
...
//            logger.info("<<<===消费者two-手动ACK-success");
//        } catch (Exception e) {
//            logger.error("<<<<消费者two-消费消息-失败 msg:{} message:{} reason{}", msg, message, e);
//            //丢弃这条消息 参数3表示是否手动ack失败是否重发
//            // TODO 重发两次发送到死信队列 发送到其他队列
//            try {
//                channel.basicNack(message.getMessageProperties().getDeliveryTag(), false, false);
//            } catch (IOException e1) {
//                logger.error("<<<<消费者two-手动NACK-失败 msg:{} message:{} reason{}", msg, message, e1);
//            }
//        }
//    }
//
